...
public class NamespaceForConceptualArchitecture extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.architecture.structure.NamespaceForConceptualArchitecture";
  ...
  public static NamespaceForConceptualArchitecture newInstance(SModel sm, boolean init) {
    return (NamespaceForConceptualArchitecture)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.structure.NamespaceForConceptualArchitecture", sm, GlobalScope.getInstance(), init).getAdapter();
  }
