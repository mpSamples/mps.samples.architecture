...
public class Component_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_3311_4(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_3311_5(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createCollection_3311_5(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_3311_4(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_3311_0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Component_Editor.publishListHandler_3311_0(node, "publish", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_publish");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }

  private EditorCell createRefNodeList_3311_1(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Component_Editor.consumeListHandler_3311_0(node, "consume", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_consume");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  ...
  private static class publishListHandler_3311_0 extends RefNodeListHandler {
    public publishListHandler_3311_0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_3311_0(editorContext, node);
    }
    ...
    private EditorCell createConstant_3311_0(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<< publishes >>");
  ...
  private static class consumeListHandler_3311_0 extends RefNodeListHandler {
    public consumeListHandler_3311_0(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_3311_1(editorContext, node);
    }
  ...
  private static class requiredInterfacesListHandler_3311_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_3311_6(editorContext, node);
    }
    ...
    private EditorCell createConstant_3311_6(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<< requires >>");
      editorCell.setCellId("Constant_3311_6");
      {
        Style style = editorCell.getStyle();
        style.set(StyleAttributes.FONT_STYLE, MPSFonts.BOLD);
        style.set(StyleAttributes.TEXT_COLOR, MPSColors.gray);
  ...
  private static class providedInterfacesListHandler_3311_0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_3311_7(editorContext, node);
    }
    ...
    private EditorCell createConstant_3311_7(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "<< provides >>");
      editorCell.setCellId("Constant_3311_7");
      {
        Style style = editorCell.getStyle();
        style.set(StyleAttributes.TEXT_COLOR, MPSColors.gray);
      }
