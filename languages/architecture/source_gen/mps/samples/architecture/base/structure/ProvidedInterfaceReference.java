...
public class ProvidedInterfaceReference extends BaseConcept {
  public static final String concept = "mps.samples.architecture.base.structure.ProvidedInterfaceReference";
  ...
  public static ProvidedInterfaceReference newInstance(SModel sm, boolean init) {
    return (ProvidedInterfaceReference)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.ProvidedInterfaceReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
