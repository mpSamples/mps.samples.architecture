...
public class NamespaceForApplicationArchitecture extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.architecture.base.structure.NamespaceForApplicationArchitecture";
  ...
  public static NamespaceForApplicationArchitecture newInstance(SModel sm, boolean init) {
    return (NamespaceForApplicationArchitecture)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.NamespaceForApplicationArchitecture", sm, GlobalScope.getInstance(), init).getAdapter();
  }
