...
public class ConceptualArchitecture extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.architecture.base.structure.ConceptualArchitecture";
  ...
  public static ConceptualArchitecture newInstance(SModel sm, boolean init) {
    return (ConceptualArchitecture)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.ConceptualArchitecture", sm, GlobalScope.getInstance(), init).getAdapter();
  }
