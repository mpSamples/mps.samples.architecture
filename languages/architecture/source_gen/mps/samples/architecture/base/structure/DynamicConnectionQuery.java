...
public class DynamicConnectionQuery extends BaseConcept {
  public static final String concept = "mps.samples.architecture.base.structure.DynamicConnectionQuery";
  ...
  public static DynamicConnectionQuery newInstance(SModel sm, boolean init) {
    return (DynamicConnectionQuery)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.DynamicConnectionQuery", sm, GlobalScope.getInstance(), init).getAdapter();
  }
