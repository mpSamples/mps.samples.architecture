...
public class InstanceReference extends BaseConcept {
  public static final String concept = "mps.samples.architecture.base.structure.InstanceReference";
  ...
  public static InstanceReference newInstance(SModel sm, boolean init) {
    return (InstanceReference)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.InstanceReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
