...
public class Connection extends BaseConcept {
  public static final String concept = "mps.samples.architecture.base.structure.Connection";
  ...
  public static Connection newInstance(SModel sm, boolean init) {
    return (Connection)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.Connection", sm, GlobalScope.getInstance(), init).getAdapter();
  }
