...
public class Instance extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.architecture.base.structure.Instance";
  ...
  public static Instance newInstance(SModel sm, boolean init) {
    return (Instance)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.Instance", sm, GlobalScope.getInstance(), init).getAdapter();
  }
