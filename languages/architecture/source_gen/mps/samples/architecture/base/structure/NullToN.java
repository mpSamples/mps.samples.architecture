...
public class NullToN extends Cardinality {
  public static final String concept = "mps.samples.architecture.base.structure.NullToN";
  ...
  public static NullToN newInstance(SModel sm, boolean init) {
    return (NullToN)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.NullToN", sm, GlobalScope.getInstance(), init).getAdapter();
  }
