...
public class RequiredInterfaceConnectionEndpoint extends ConnectionEndpoint {
  public static final String concept = "mps.samples.architecture.base.structure.RequiredInterfaceConnectionEndpoint";
  ...
  public static RequiredInterfaceConnectionEndpoint newInstance(SModel sm, boolean init) {
    return (RequiredInterfaceConnectionEndpoint)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.RequiredInterfaceConnectionEndpoint", sm, GlobalScope.getInstance(), init).getAdapter();
  }
