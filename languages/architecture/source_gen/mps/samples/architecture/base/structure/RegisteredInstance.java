...
public class RegisteredInstance extends Instance {
  public static final String concept = "mps.samples.architecture.base.structure.RegisteredInstance";
  ...
  public static RegisteredInstance newInstance(SModel sm, boolean init) {
    return (RegisteredInstance)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.RegisteredInstance", sm, GlobalScope.getInstance(), init).getAdapter();
  }
