...
public class System extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.architecture.base.structure.System";
  ...
  public static System newInstance(SModel sm, boolean init) {
    return (System)SModelUtil_new.instantiateConceptDeclaration("mps.samples.architecture.base.structure.System", sm, GlobalScope.getInstance(), init).getAdapter();
  }
