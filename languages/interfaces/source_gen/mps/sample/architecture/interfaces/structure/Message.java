...
public class Message extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.sample.architecture.interfaces.structure.Message";
  ...
  public static Message newInstance(SModel sm, boolean init) {
    return (Message)SModelUtil_new.instantiateConceptDeclaration("mps.sample.architecture.interfaces.structure.Message", sm, GlobalScope.getInstance(), init).getAdapter();
  }
