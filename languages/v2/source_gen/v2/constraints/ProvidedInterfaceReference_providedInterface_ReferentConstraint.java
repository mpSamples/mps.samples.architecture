...
public class ProvidedInterfaceReference_providedInterface_ReferentConstraint extends BaseNodeReferenceSearchScopeProvider implements IModelConstraints {
  ...
  public void registerSelf(ModelConstraintsManager manager) {
    manager.registerNodeReferentSearchScopeProvider("v2.structure.ProvidedInterfaceReference", "providedInterface", this);
  }

  public void unRegisterSelf(ModelConstraintsManager manager) {
    manager.unRegisterNodeReferentSearchScopeProvider("v2.structure.ProvidedInterfaceReference", "providedInterface");
  }
