...
public class NullToN extends Cardinality {
  public static final String concept = "v2.structure.NullToN";
  ...
  public static NullToN newInstance(SModel sm, boolean init) {
    return (NullToN)SModelUtil_new.instantiateConceptDeclaration("v2.structure.NullToN", sm, GlobalScope.getInstance(), init).getAdapter();
  }
