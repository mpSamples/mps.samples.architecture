...
public class RequiredInterfaceConnectionEndpoint extends ConnectionEndpoint {
  public static final String concept = "v2.structure.RequiredInterfaceConnectionEndpoint";
  ...
  public static RequiredInterfaceConnectionEndpoint newInstance(SModel sm, boolean init) {
    return (RequiredInterfaceConnectionEndpoint)SModelUtil_new.instantiateConceptDeclaration("v2.structure.RequiredInterfaceConnectionEndpoint", sm, GlobalScope.getInstance(), init).getAdapter();
  }
