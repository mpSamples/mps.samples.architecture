...
public class DynamicConnection extends BaseConcept {
  public static final String concept = "v2.structure.DynamicConnection";
  ...
  public static DynamicConnection newInstance(SModel sm, boolean init) {
    return (DynamicConnection)SModelUtil_new.instantiateConceptDeclaration("v2.structure.DynamicConnection", sm, GlobalScope.getInstance(), init).getAdapter();
  }
