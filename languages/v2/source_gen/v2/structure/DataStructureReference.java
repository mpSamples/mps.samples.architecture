...
public class DataStructureReference extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.DataStructureReference";
  ...
  public static DataStructureReference newInstance(SModel sm, boolean init) {
    return (DataStructureReference)SModelUtil_new.instantiateConceptDeclaration("v2.structure.DataStructureReference", sm, GlobalScope.getInstance(), init).getAdapter();
  }
