...
public class RegisteredInstance extends Instance {
  public static final String concept = "v2.structure.RegisteredInstance";
  ...
  public static RegisteredInstance newInstance(SModel sm, boolean init) {
    return (RegisteredInstance)SModelUtil_new.instantiateConceptDeclaration("v2.structure.RegisteredInstance", sm, GlobalScope.getInstance(), init).getAdapter();
  }
