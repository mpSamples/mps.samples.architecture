...
public class System extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.System";
  ...
  public static System newInstance(SModel sm, boolean init) {
    return (System)SModelUtil_new.instantiateConceptDeclaration("v2.structure.System", sm, GlobalScope.getInstance(), init).getAdapter();
  }
