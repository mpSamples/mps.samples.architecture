...
public class Instance extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.Instance";
  ...
  public static Instance newInstance(SModel sm, boolean init) {
    return (Instance)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Instance", sm, GlobalScope.getInstance(), init).getAdapter();
  }
