...
public class Connection extends BaseConcept {
  public static final String concept = "v2.structure.Connection";
  ...
  public static Connection newInstance(SModel sm, boolean init) {
    return (Connection)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Connection", sm, GlobalScope.getInstance(), init).getAdapter();
  }
