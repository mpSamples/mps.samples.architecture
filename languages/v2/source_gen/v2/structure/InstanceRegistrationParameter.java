...
public class InstanceRegistrationParameter extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.InstanceRegistrationParameter";
  ...
  public static InstanceRegistrationParameter newInstance(SModel sm, boolean init) {
    return (InstanceRegistrationParameter)SModelUtil_new.instantiateConceptDeclaration("v2.structure.InstanceRegistrationParameter", sm, GlobalScope.getInstance(), init).getAdapter();
  }
