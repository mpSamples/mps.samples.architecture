...
public class DataStructure extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.DataStructure";
  ...
  public static DataStructure newInstance(SModel sm, boolean init) {
    return (DataStructure)SModelUtil_new.instantiateConceptDeclaration("v2.structure.DataStructure", sm, GlobalScope.getInstance(), init).getAdapter();
  }
