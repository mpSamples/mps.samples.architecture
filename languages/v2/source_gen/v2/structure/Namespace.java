...
import mps.samples.architecture.structure.System;
import jetbrains.mps.smodel.SModel;
import jetbrains.mps.smodel.SModelUtil_new;
import jetbrains.mps.project.GlobalScope;

public class Namespace extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.Namespace";
  ...
  public static Namespace newInstance(SModel sm, boolean init) {
    return (Namespace)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Namespace", sm, GlobalScope.getInstance(), init).getAdapter();
  }
