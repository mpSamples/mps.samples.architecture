...
public class ReplicatedItem extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.ReplicatedItem";
  ...
  public static ReplicatedItem newInstance(SModel sm, boolean init) {
    return (ReplicatedItem)SModelUtil_new.instantiateConceptDeclaration("v2.structure.ReplicatedItem", sm, GlobalScope.getInstance(), init).getAdapter();
  }
