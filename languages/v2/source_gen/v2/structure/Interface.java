...
public class Interface extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.Interface";
  ...
  public static Interface newInstance(SModel sm, boolean init) {
    return (Interface)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Interface", sm, GlobalScope.getInstance(), init).getAdapter();
  }
