...
public class DynamicConnectionQuery extends BaseConcept {
  public static final String concept = "v2.structure.DynamicConnectionQuery";
  ...
  public static DynamicConnectionQuery newInstance(SModel sm, boolean init) {
    return (DynamicConnectionQuery)SModelUtil_new.instantiateConceptDeclaration("v2.structure.DynamicConnectionQuery", sm, GlobalScope.getInstance(), init).getAdapter();
  }
