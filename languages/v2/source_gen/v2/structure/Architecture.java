...
public class Architecture extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.Architecture";
  ...
  public static Architecture newInstance(SModel sm, boolean init) {
    return (Architecture)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Architecture", sm, GlobalScope.getInstance(), init).getAdapter();
  }
