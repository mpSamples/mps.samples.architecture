...
public class Component extends BaseConcept implements INamedConcept {
  public static final String concept = "v2.structure.Component";
  ...
  public static Component newInstance(SModel sm, boolean init) {
    return (Component)SModelUtil_new.instantiateConceptDeclaration("v2.structure.Component", sm, GlobalScope.getInstance(), init).getAdapter();
  }
